...
public class ModShield extends Item implements Equipable {public static final int EFFECTIVE_BLOCK_DELAY = 5;
    public static final float MINIMUM_DURABILITY_DAMAGE = 3.0F;
    public static final String TAG_BASE_COLOR = "Base";

    public ModShield(Item.Properties p_43089_) {
        super(p_43089_);
    ...
    public boolean isValidRepairItem(ItemStack p_43091_, ItemStack p_43092_) {
        return p_43092_.is(ModItems.CHITIN.get()) || super.isValidRepairItem(p_43091_, p_43092_);
    }
