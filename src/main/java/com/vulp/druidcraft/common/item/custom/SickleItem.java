...
import com.vulp.druidcraft.common.util.BlockHelper;
...
public class SickleItem extends DiggerItem {
    ...
    public float getDestroySpeed(ItemStack stack, BlockState state) {
        return state.is(ModTags.Blocks.MINEABLE_WITH_SICKLE) ? this.getTier().getSpeed() / 2 : super.getDestroySpeed(stack, state);
    }
