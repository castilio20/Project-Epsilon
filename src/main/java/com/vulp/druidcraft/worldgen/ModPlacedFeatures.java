...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> NETHER_FIERY_GLASS_ORE_PLACED_KEY = registerKey("nether_fiery_glass_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, NETHER_FIERY_GLASS_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.NETHER_NETHER_FIERY_GLASS_KEY),
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Druidcraft.MODID, name));
    }
