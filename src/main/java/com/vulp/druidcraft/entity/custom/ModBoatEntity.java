...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case DARKWOOD -> ModItems.DARKWOOD_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.DARKWOOD.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        DARKWOOD(ModBlocks.DARKWOOD_PLANKS.get(), "darkwood");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, DARKWOOD);
        }
    }
}